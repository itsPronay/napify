...
import com.pronaycoding.blanket_mobile.MainActivity
import com.pronaycoding.blanket_mobile.R
import dagger.hilt.android.AndroidEntryPoint
import javax.inject.Inject

@AndroidEntryPoint
class NapifyMediaPlaybackService : Service() {

    @Inject
    lateinit var globalPlaybackState: GlobalPlaybackState
    ...
    override fun onCreate() {
        super.onCreate()
        createChannel()
        mediaSession = MediaSessionCompat(this, "NapifyPlayback").apply {
    ...
    private fun buildNotification(canPlay: Boolean, hasMix: Boolean): android.app.Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentText(text)
            .setSmallIcon(R.drawable.ic_stat_napify)
    ...
    companion object {
        const val CHANNEL_ID = "napify_playback"
        const val NOTIFICATION_ID = 7101
        private const val ACTION_UPDATE = "com.pronaycoding.blanket_mobile.action.UPDATE_PLAYBACK_NOTIFICATION"
        ...
        fun intentUpdate(context: android.content.Context, canPlay: Boolean, hasAudibleMix: Boolean): Intent {
            return Intent(context, NapifyMediaPlaybackService::class.java).apply {
