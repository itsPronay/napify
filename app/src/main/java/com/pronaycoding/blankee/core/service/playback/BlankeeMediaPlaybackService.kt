...
class BlankeeMediaPlaybackService : Service() {
    ...
    private fun buildNotification(canPlay: Boolean, hasMix: Boolean): Notification {
    ...
    companion object {
        ...
        fun intentUpdate(context: Context, canPlay: Boolean, hasAudibleMix: Boolean): Intent {
